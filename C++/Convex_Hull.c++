...
//Berguna untuk center dari polygon
pair<int, int> mid;

// Untuk menetukan Quadran dari titik
...
// Ngecek apakah garis melewati polygon
...
// Fungsi Untuk Menemukan Polygon a dan b
...
vector<pair<int, int>> divide(vector<pair<int, int>> a)
{
	...
	// Rekursif Convex Hull Kiri dan Kanan
	vector<pair<int, int>>left_hull = divide(left);
	vector<pair<int, int>>right_hull = divide(right);

	// Gabungkan Convex Hull Kiri dan Kanan
...
int main()
{
	...
	//Sorting Berdasarkan Koordinat x
	sort(a.begin(), a.end());
	vector<pair<int, int> >ans = divide(a);

	cout << "Hasil Convex Hull nya adalah \n";
	for (auto e:ans)
